...
contract L2StandardBridge is StandardBridge {
    ...
    ///         This function only works with LightLinkMintableERC20 tokens or ether. Use the
    ...
    function withdraw(
        ...
        require(
            ...
            "L2StandardBridge: not supported with custom gas token"
        );
        _initiateWithdrawal(
            _l2Token,
            msg.sender,
    ...
    function _initiateWithdrawal(
        ...
        if (_l2Token == legacyERC20ETH) {
            ...
            address l1Token = LightLinkMintableERC20(_l2Token).l1Token();
