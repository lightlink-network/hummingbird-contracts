...
// MAXPOINTERS is a free data retrieval call binding the contract method 0x96e56cfe.
//
// Solidity: function MAX_POINTERS() view returns(uint8)
func (_CanonicalStateChain *CanonicalStateChainCaller) MAXPOINTERS(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _CanonicalStateChain.contract.Call(opts, &out, "MAX_POINTERS")
