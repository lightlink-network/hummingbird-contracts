...
// FinalizationSeconds is a free data retrieval call binding the contract method 0x98e2dffb.
//
// Solidity: function finalizationSeconds() view returns(uint256)
func (_Challenge *ChallengeCaller) FinalizationSeconds(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Challenge.contract.Call(opts, &out, "finalizationSeconds")
...
//
// Solidity: function finalizationSeconds() view returns(uint256)
func (_Challenge *ChallengeSession) FinalizationSeconds() (*big.Int, error) {
	return _Challenge.Contract.FinalizationSeconds(&_Challenge.CallOpts)
}

// FinalizationSeconds is a free data retrieval call binding the contract method 0x98e2dffb.
//
// Solidity: function finalizationSeconds() view returns(uint256)
func (_Challenge *ChallengeCallerSession) FinalizationSeconds() (*big.Int, error) {
	return _Challenge.Contract.FinalizationSeconds(&_Challenge.CallOpts)
}
...
// DefendDataRootInclusion is a paid mutator transaction binding the contract method 0x0eea9bab.
//
// Solidity: function defendDataRootInclusion(bytes32 _challengeKey, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof) returns()
func (_Challenge *ChallengeTransactor) DefendDataRootInclusion(opts *bind.TransactOpts, _challengeKey [32]byte, _proof SharesProof) (*types.Transaction, error) {
...
//
// Solidity: function defendDataRootInclusion(bytes32 _challengeKey, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof) returns()
func (_Challenge *ChallengeSession) DefendDataRootInclusion(_challengeKey [32]byte, _proof SharesProof) (*types.Transaction, error) {
...
//
// Solidity: function defendDataRootInclusion(bytes32 _challengeKey, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof) returns()
func (_Challenge *ChallengeTransactorSession) DefendDataRootInclusion(_challengeKey [32]byte, _proof SharesProof) (*types.Transaction, error) {
	return _Challenge.Contract.DefendDataRootInclusion(&_Challenge.TransactOpts, _challengeKey, _proof)
}
...
// SetDAOracle is a paid mutator transaction binding the contract method 0xa3be6534.
//
// Solidity: function setDAOracle(address _daOracle) returns()
func (_Challenge *ChallengeTransactor) SetDAOracle(opts *bind.TransactOpts, _daOracle common.Address) (*types.Transaction, error) {
	return _Challenge.contract.Transact(opts, "setDAOracle", _daOracle)
}

// SetDAOracle is a paid mutator transaction binding the contract method 0xa3be6534.
//
// Solidity: function setDAOracle(address _daOracle) returns()
func (_Challenge *ChallengeSession) SetDAOracle(_daOracle common.Address) (*types.Transaction, error) {
	return _Challenge.Contract.SetDAOracle(&_Challenge.TransactOpts, _daOracle)
}

// SetDAOracle is a paid mutator transaction binding the contract method 0xa3be6534.
//
// Solidity: function setDAOracle(address _daOracle) returns()
func (_Challenge *ChallengeTransactorSession) SetDAOracle(_daOracle common.Address) (*types.Transaction, error) {
	return _Challenge.Contract.SetDAOracle(&_Challenge.TransactOpts, _daOracle)
}
