...
// VerifyShareRoot is a free data retrieval call binding the contract method 0x79fb0a33.
//
// Solidity: function verifyShareRoot(bytes32 _shareRoot, bytes[] _shares, (bytes32[],uint256,uint256)[] _merkleProofs) pure returns(bool)
func (_ChainOracle *ChainOracleCaller) VerifyShareRoot(opts *bind.CallOpts, _shareRoot [32]byte, _shares [][]byte, _merkleProofs []BinaryMerkleProof) (bool, error) {
	var out []interface{}
	err := _ChainOracle.contract.Call(opts, &out, "verifyShareRoot", _shareRoot, _shares, _merkleProofs)
...
//
// Solidity: function verifyShareRoot(bytes32 _shareRoot, bytes[] _shares, (bytes32[],uint256,uint256)[] _merkleProofs) pure returns(bool)
func (_ChainOracle *ChainOracleSession) VerifyShareRoot(_shareRoot [32]byte, _shares [][]byte, _merkleProofs []BinaryMerkleProof) (bool, error) {
	return _ChainOracle.Contract.VerifyShareRoot(&_ChainOracle.CallOpts, _shareRoot, _shares, _merkleProofs)
}

// VerifyShareRoot is a free data retrieval call binding the contract method 0x79fb0a33.
//
// Solidity: function verifyShareRoot(bytes32 _shareRoot, bytes[] _shares, (bytes32[],uint256,uint256)[] _merkleProofs) pure returns(bool)
func (_ChainOracle *ChainOracleCallerSession) VerifyShareRoot(_shareRoot [32]byte, _shares [][]byte, _merkleProofs []BinaryMerkleProof) (bool, error) {
	return _ChainOracle.Contract.VerifyShareRoot(&_ChainOracle.CallOpts, _shareRoot, _shares, _merkleProofs)
}
...
// ProvideShares is a paid mutator transaction binding the contract method 0xbfc36946.
//
// Solidity: function provideShares(bytes32 _rblock, uint8 _pointer, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _blobstreamProof, (bytes32[],uint256,uint256)[] _pointerProof) returns(bytes32)
func (_ChainOracle *ChainOracleTransactor) ProvideShares(opts *bind.TransactOpts, _rblock [32]byte, _pointer uint8, _blobstreamProof SharesProof, _pointerProof []BinaryMerkleProof) (*types.Transaction, error) {
	return _ChainOracle.contract.Transact(opts, "provideShares", _rblock, _pointer, _blobstreamProof, _pointerProof)
}

// ProvideShares is a paid mutator transaction binding the contract method 0xbfc36946.
//
// Solidity: function provideShares(bytes32 _rblock, uint8 _pointer, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _blobstreamProof, (bytes32[],uint256,uint256)[] _pointerProof) returns(bytes32)
func (_ChainOracle *ChainOracleSession) ProvideShares(_rblock [32]byte, _pointer uint8, _blobstreamProof SharesProof, _pointerProof []BinaryMerkleProof) (*types.Transaction, error) {
	return _ChainOracle.Contract.ProvideShares(&_ChainOracle.TransactOpts, _rblock, _pointer, _blobstreamProof, _pointerProof)
}

// ProvideShares is a paid mutator transaction binding the contract method 0xbfc36946.
//
// Solidity: function provideShares(bytes32 _rblock, uint8 _pointer, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _blobstreamProof, (bytes32[],uint256,uint256)[] _pointerProof) returns(bytes32)
func (_ChainOracle *ChainOracleTransactorSession) ProvideShares(_rblock [32]byte, _pointer uint8, _blobstreamProof SharesProof, _pointerProof []BinaryMerkleProof) (*types.Transaction, error) {
	return _ChainOracle.Contract.ProvideShares(&_ChainOracle.TransactOpts, _rblock, _pointer, _blobstreamProof, _pointerProof)
}
