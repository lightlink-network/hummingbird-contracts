...
//
// Solidity: function provideShares(bytes32 _rblock, uint8 _pointer, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof, (bytes32[],uint256,uint256)[] _blockProof) returns(bytes32)
func (_ChainOracle *ChainOracleTransactor) ProvideShares(opts *bind.TransactOpts, _rblock [32]byte, _pointer uint8, _proof SharesProof, _blockProof []BinaryMerkleProof) (*types.Transaction, error) {
	return _ChainOracle.contract.Transact(opts, "provideShares", _rblock, _pointer, _proof, _blockProof)
}

// ProvideShares is a paid mutator transaction binding the contract method 0xbfc36946.
//
// Solidity: function provideShares(bytes32 _rblock, uint8 _pointer, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof, (bytes32[],uint256,uint256)[] _blockProof) returns(bytes32)
func (_ChainOracle *ChainOracleSession) ProvideShares(_rblock [32]byte, _pointer uint8, _proof SharesProof, _blockProof []BinaryMerkleProof) (*types.Transaction, error) {
	return _ChainOracle.Contract.ProvideShares(&_ChainOracle.TransactOpts, _rblock, _pointer, _proof, _blockProof)
}

// ProvideShares is a paid mutator transaction binding the contract method 0xbfc36946.
//
// Solidity: function provideShares(bytes32 _rblock, uint8 _pointer, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof, (bytes32[],uint256,uint256)[] _blockProof) returns(bytes32)
func (_ChainOracle *ChainOracleTransactorSession) ProvideShares(_rblock [32]byte, _pointer uint8, _proof SharesProof, _blockProof []BinaryMerkleProof) (*types.Transaction, error) {
	return _ChainOracle.Contract.ProvideShares(&_ChainOracle.TransactOpts, _rblock, _pointer, _proof, _blockProof)
}
