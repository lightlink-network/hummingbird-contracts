...
func (_ChainOracle *ChainOracleTransactor) SetDAOracle(opts *bind.TransactOpts, _daOracle common.Address) (*types.Transaction, error) {
	return _ChainOracle.contract.Transact(opts, "setDAOracle", _daOracle)
}

// SetDAOracle is a paid mutator transaction binding the contract method 0xa3be6534.
//
// Solidity: function setDAOracle(address _daOracle) returns()
func (_ChainOracle *ChainOracleSession) SetDAOracle(_daOracle common.Address) (*types.Transaction, error) {
	return _ChainOracle.Contract.SetDAOracle(&_ChainOracle.TransactOpts, _daOracle)
}

// SetDAOracle is a paid mutator transaction binding the contract method 0xa3be6534.
//
// Solidity: function setDAOracle(address _daOracle) returns()
func (_ChainOracle *ChainOracleTransactorSession) SetDAOracle(_daOracle common.Address) (*types.Transaction, error) {
	return _ChainOracle.Contract.SetDAOracle(&_ChainOracle.TransactOpts, _daOracle)
}
